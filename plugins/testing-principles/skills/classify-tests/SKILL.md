...
4. Read [classification](../../references/classification.md) and [dependencies](../../references/dependencies.md). Classify:
   ...
   - assertion targets as observable behavior or implementation details at the stated boundary.
